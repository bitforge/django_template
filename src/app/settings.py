...
SECRET_KEY = env('SECRET_KEY', default='w3j+u&2caq+lvo%idyr3b2!0#6*&9xy%rim7bmmjt1k*506us*')
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'src', 'app', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
if env('PGURL') and 'test' not in sys.argv:
    DATABASES = {'default': env.db_url('PGURL')}
